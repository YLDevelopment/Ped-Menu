...
RegisterNetEvent('YlMenu:client:sendalert')
AddEventHandler('ylmmenu:client:sendalert', function(data)
...
Citizen.CreateThread(function()
	TriggerServerEvent("YlMenu:openmenucheck")
end)

RegisterNetEvent("YlMenu:openmenu")
AddEventHandler("YlMenu:openmenu", function(isAllowedtoOpenMenu)
...
Citizen.CreateThread(function()
	...
	WarMenu.CreateMenu('yl', 'WarMenu')
	WarMenu.SetSubTitle('yl', 'Ped Menu')
	WarMenu.CreateSubMenu('ped', 'yl', 'Ped Menu')


	while true do
		playerhealth = GetEntityHealth(GetPlayerPed(selectedPlayer))
		playerarmor = GetPedArmour(GetPlayerPed(selectedPlayer))
		if WarMenu.IsMenuOpened('yl') then
